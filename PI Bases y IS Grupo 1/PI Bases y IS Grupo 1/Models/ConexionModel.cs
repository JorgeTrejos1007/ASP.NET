...
namespace PIBasesISGrupo1.Models
{
    public class ConexionModel
    {
        ...
        public SqlConnection Connection() {
            ...
            SqlConnection con;
            //string conString = @"Server=grupo1.database.windows.net;Database=Grupo1_BD;User ID=Grupo1;password=Adriancito1;";
            ...
            //string conString = @"Server=LAPTOP-3EUSIQQG\ADRIANCITO;Database=BD_Grupo1Local;Integrated Security = True;Pooling = False";
